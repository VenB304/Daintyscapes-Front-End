...
CALL debug_change_buyer_into_admin('1', 'admin1');
...
CALL debug_change_buyer_into_seller('2', 'seller1');

CALL add_buyer('Kusu', 'gaki', 'buyer1', '$2y$10$ysnGZt/sCBerBI2P6KX1dOWMevfPPZ8iAuZQpf9uPmm2SWTwjI5Ue', 'kusagaki@gmail.com', '09386254685', 'Philippines', 'Santa Clara', 'Totod', '23', '3746');

CALL add_order_status();
